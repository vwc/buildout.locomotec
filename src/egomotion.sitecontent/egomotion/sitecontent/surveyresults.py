    ...
    def field_lsit(self):
        fields = 
            {'functionality.additional': 'Funktion Freitext',
             ...
             'participant.investment': ['100', 'participant.investment.1', 'participant.investment.2', 'participant.investment.3', 'participant.investment.4', 'participant.investment.5'],
             'training.personalization': 'very important',
             'functionality': ['functionality.1', 'functionality.2', 'functionality.3', 'functionality.4', 'functionality.5', 'functionality.6', 'functionality.7'],
             ...
             'price.club': 'option1',
             'trainingresource': ['trainingresource.1', 'trainingresource.2', 'trainingresource.3', 'trainingresource.4', 'trainingresource.5', 'trainingresource.6', 'trainingresource.7', 'trainingresource.8', 'trainingresource.9', 'trainingresource.10'],
